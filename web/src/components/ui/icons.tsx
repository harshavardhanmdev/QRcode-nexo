...
/**
 * Inline icon set (paths from Lucide, ISC license — lucide.dev).
 * Hand-inlined instead of importing lucide-react: zero dependency weight,
 * tree-shaking guaranteed, one stroke style everywhere.
 */
